...
unsigned int nStakeMaxAge = 36 * 60 * 60;  //36hrs
...
const string strMessageMagic = "CaponeCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CaponeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.caponecoin.com/2016/01/08/Cryptomafia/haters/gonna/hate.html";
        CTransaction txNew;
        txNew.nTime = 1452273706;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	printf("Searching for genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xaae30391f95965c0331a749ae60174f683c0acebdc9803a83bb13388b58e70fe"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb9, 0x4e, 0x5a };
